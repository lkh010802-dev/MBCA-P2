...
def parse_user_intent(
    ...
    record('llm', user_input=user_input, llm_raw_intent=outcome['llm_intent'],
           postprocess_changes=outcome['postprocess_changes'], final_intent=outcome['intent'],
           openai_request_id=outcome.get('request_id'), runtime=outcome.get('runtime'), usage=outcome.get('usage'))
