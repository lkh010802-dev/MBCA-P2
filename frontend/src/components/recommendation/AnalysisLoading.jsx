...
import koalaLoadingSmall from '../../assets/images/koala-loading-small.png'
...
function AnalysisLoading({ onEdit, onCancel }) {
  ...
  return (
    <main className="analysis-page">
      <div className="analysis-koala-wrap"><img className="analysis-koala" src={koalaLoadingSmall} alt="지도를 보며 코스를 생각하는 코알라" decoding="async" onError={(event) => { event.currentTarget.style.display = 'none'; event.currentTarget.parentElement?.classList.add('is-fallback') }} /></div>
