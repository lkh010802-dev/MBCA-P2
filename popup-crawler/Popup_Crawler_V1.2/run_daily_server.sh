...
export POPPLY_DETAIL_CACHE_HOURS="168"
export POPPLY_DETAIL_REFRESH_AFTER_HOURS="48"
export POPPLY_DETAIL_REFRESH_BUDGET="20"
export POPPLY_DETAIL_WORKERS="2"
...
echo "[STATE] POPPLY_DETAIL_CACHE_HOURS=$POPPLY_DETAIL_CACHE_HOURS"
echo "[STATE] POPPLY_DETAIL_REFRESH_AFTER_HOURS=$POPPLY_DETAIL_REFRESH_AFTER_HOURS"
echo "[STATE] POPPLY_DETAIL_REFRESH_BUDGET=$POPPLY_DETAIL_REFRESH_BUDGET"
echo "[STATE] POPPLY_DETAIL_WORKERS=$POPPLY_DETAIL_WORKERS"
