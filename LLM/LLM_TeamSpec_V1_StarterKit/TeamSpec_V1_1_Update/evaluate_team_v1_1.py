...
def main():
    ...
    ap.add_argument("--golden", default=str(HERE / "golden_tests_50_team_v1_1.jsonl"))
    ap.add_argument("--schema", default=str(HERE / "user_intent_schema_team_v1_1.json"))
    ap.add_argument("--out-dir", default=str(HERE / "evaluation_result_team_v1_1"))
    args = ap.parse_args()
    ...
    summary = {
        "test_suite": "TeamSpec V1.1 Golden 50",
        "cases_expected": n,
